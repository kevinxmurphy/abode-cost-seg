 ...
 */
export async function captureEmail({ email, source, propertyAddress, quizData, utmSource, utmMedium, utmCampaign }) {
 ...
 * @returns {Promise<boolean>}
 */
export async function saveContactSubmission({ name, email, phone, message, source, utmSource, utmMedium, utmCampaign }) {
  if (!email) return false;
