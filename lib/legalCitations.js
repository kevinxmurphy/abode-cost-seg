...
export const METHODOLOGY_TEXT = {
  ...
  dataSources:
    "Data Sources. The cost allocations in this study are derived from the following sources: (1) property listing data including photographs, descriptions, and feature lists; (2) public property records including tax assessor data, building permits, and property characteristics; (3) construction cost databases including RSMeans, Marshall & Swift, and regional cost indices; (4) component-level engineering estimates based on property type, age, size, quality tier, and geographic location; (5) comparable property analysis using properties of similar type, vintage, and quality in the same geographic market; and (6) owner-provided information regarding renovations, improvements, and property condition.",
