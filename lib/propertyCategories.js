    ...
    items: [
      ...
      },
      {
        ...
        options: [
          ...
          { value: "pool-lighting", label: "Pool Lighting" },
      ...
      },
      {
        ...
        options: [
          ...
          { value: "pergola", label: "Pergola / Covered Patio" },
          { value: "outdoor-shower", label: "Outdoor Shower" },
          { value: "sport-court", label: "Sport Court (basketball, pickleball, etc.)" },
    ...
    items: [
      {
        ...
        type: "multi",
        options: [
          { value: "game-room", label: "Game Room (pool table, arcade, etc.)" },
          { value: "home-gym", label: "Home Gym / Fitness Equipment" },
          { value: "wine-cellar", label: "Wine Cellar / Bar" },
