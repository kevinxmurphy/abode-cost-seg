...
export const PROPERTY_CATEGORIES = [
  ...
  {
    id: "furniture",
    name: "Furniture & Personal Property",
    icon: "🛋️",
    description: "All movable furnishings, electronics, and personal property used in the rental",
    depreciationNote: "Furniture and personal property is 5-year MACRS — fully eligible for 100% bonus depreciation in year one",
    items: [
      {
        id: "str-setup",
        label: "How was the property furnished / equipped for STR?",
        type: "select",
        options: [
          { value: "full-scratch", label: "Fully furnished from scratch — bought everything new", tier: "premium" },
          { value: "full-upgrade", label: "Existing furniture but significantly upgraded for STR", tier: "premium" },
          { value: "partial", label: "Partially furnished / added key pieces", tier: "mid" },
          { value: "minimal", label: "Minor additions only — already guest-ready", tier: "standard" },
          { value: "existing", label: "Used existing furniture, no notable purchases", tier: "none" },
        ],
        assetLife: "5-year",
      },
      {
        id: "furniture-tier",
        label: "Overall Furniture Quality",
        type: "select",
        options: [
          { value: "luxury", label: "Luxury / Designer (Restoration Hardware, custom, Arhaus)", tier: "luxury" },
          { value: "premium", label: "Premium (Pottery Barn, West Elm, Crate & Barrel)", tier: "premium" },
          { value: "mid", label: "Mid-Range (Wayfair, Ashley, Article)", tier: "mid" },
          { value: "budget", label: "Budget / Starter (IKEA, thrift, basic big-box)", tier: "standard" },
        ],
        assetLife: "5-year",
      },
      {
        ...
        type: "select",
        options: [
          { value: "luxury", label: "Luxury (teak, Frontgate, Restoration Hardware Outdoor)", tier: "luxury" },
          { value: "premium", label: "Premium (Telescope, Brown Jordan, quality aluminum sets)", tier: "premium" },
          { value: "mid", label: "Mid-Range (resin wicker, basic aluminum dining/lounge sets)", tier: "mid" },
          { value: "none", label: "None / Minimal", tier: "none" },
        ],
        assetLife: "5-year",
        excludePropertyTypes: ["Condo"],
      },
      {
        ...
        type: "multi",
        options: [
          { value: "multiple-tvs", label: "Multiple large TVs (55\"+ in several rooms)" },
          { value: "gaming-setup", label: "Gaming console setup (PS5, Xbox, Nintendo Switch)" },
          { value: "sound-system", label: "Portable / room sound system (Sonos, Bose)" },
          { value: "streaming-devices", label: "Streaming devices / Apple TV / Fire Stick (each room)" },
          { value: "projector", label: "Projector / Screen" },
          { value: "arcade-games", label: "Arcade / pinball machines" },
        ],
        assetLife: "5-year",
      },
      {
        id: "small-appliances",
        label: "Small Appliances & Kitchen Equipment",
        type: "multi",
        options: [
          { value: "espresso", label: "Espresso machine / Keurig / Nespresso" },
          { value: "specialty-cooking", label: "Instant Pot / Air Fryer / specialty appliances" },
          { value: "vitamix", label: "High-end blender (Vitamix, Breville)" },
          { value: "waffle-iron", label: "Waffle iron / panini press / specialty breakfast items" },
          { value: "outdoor-grill-portable", label: "Portable / standalone BBQ grill or smoker" },
          { value: "pizza-oven", label: "Outdoor pizza oven" },
          { value: "ice-maker", label: "Standalone ice maker / nugget ice machine" },
          { value: "beverage-fridge", label: "Beverage fridge / kegerator / wine cooler" },
        ],
        assetLife: "5-year",
      },
      {
        id: "linens-supplies",
        label: "Linens, Supplies & Guest Amenities",
        type: "select",
        options: [
          { value: "hotel-grade", label: "Hotel-grade linens, towels, full starter supplies (significant spend)", tier: "premium" },
          { value: "standard-full", label: "Standard full set of linens and supplies", tier: "mid" },
          { value: "basic", label: "Basic / minimal supplies only", tier: "standard" },
        ],
        assetLife: "5-year",
      },
      {
        id: "str-specific",
        label: "STR-Specific Purchases",
        type: "multi",
        options: [
          { value: "welcome-decor", label: "Welcome station / branded decor / local art" },
          { value: "bikes-kayaks", label: "Bikes, kayaks, paddleboards, or activity gear" },
          { value: "beach-gear", label: "Beach / pool toys, chairs, umbrellas, floats" },
          { value: "high-chair-crib", label: "High chair, pack-n-play, kid gear" },
          { value: "board-games", label: "Board games, puzzles, books, activity kits" },
          { value: "luggage-rack", label: "Luggage racks, extra closet organizers" },
          { value: "outdoor-heater", label: "Patio / outdoor heaters (propane or electric)" },
          { value: "fire-table", label: "Fire table / propane fire pit" },
        ],
        assetLife: "5-year",
      },
    ],
