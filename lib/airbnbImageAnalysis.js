...
const ROOM_CATEGORIES = {
  kitchen: {
    label: "Kitchen",
    keywords: ["kitchen", "cooking", "stove", "oven", "refrigerator", "dishwasher", "pantry", "chef"],
    costSegIds: ["kitchen"],
    icon: "kitchen",
  },
  bedroom: {
    label: "Bedroom / Furniture",
    keywords: ["bedroom", "master bed", "guest bed", "bunk bed", "sleeping", "nursery", "kids room", "kid's room", "children's room"],
    costSegIds: ["interior", "specialty"],
    icon: "bedroom",
  },
  bathroom: {
    label: "Bathroom",
    keywords: ["bathroom", "bath ", "bath,", "ensuite", "en-suite", "en suite", "restroom", "vanity", "shower", "tub", "toilet", "powder room", "half bath"],
  ...
  outdoor: {
    ...
    keywords: [
      "pool", "backyard", "back yard", "patio", "outdoor", "outside", "exterior",
      "yard", "garden", "lawn", "deck", "hot tub", "jacuzzi", "spa ",
      "fire pit", "firepit", "bbq", "grill", "pergola", "gazebo",
      "sun deck", "lounger", "terrace", "balcony", "driveway", "parking",
      "courtyard", "cabana", "pool house", "poolhouse", "waterfront",
      "dock", "boat", "lake", "beach", "ocean view", "water view",
    ],
    costSegIds: ["outdoor"],
    icon: "outdoor",
  },
  living: {
    label: "Living Area",
    keywords: ["living", "lounge", "sitting", "family room", "tv room", "den", "great room", "common area", "gathering"],
    costSegIds: ["interior", "smart-home"],
    icon: "living",
  },
  furniture: {
    label: "Furniture & Personal Property",
    keywords: [
      "furniture", "patio furniture", "outdoor furniture", "lounge chair", "chaise",
      "dining set", "sofa", "couch", "sectional", "armchair", "coffee table",
      "kayak", "paddleboard", "bikes", "fire table", "pizza oven",
    ],
    costSegIds: ["furniture"],
    icon: "furniture",
  },
  general: {
    label: "General",
...
const CAPTION_AMENITY_PATTERNS = [
  ...
  { pattern: /tile counter|tile countertop/i, amenity: "Tile countertops", costSegCategory: "kitchen", costSegItem: "countertops" },
  { pattern: /butcher.?block/i, amenity: "Butcher block countertops", costSegCategory: "kitchen", costSegItem: "countertops" },
  { pattern: /stainless steel/i, amenity: "Stainless steel appliances", costSegCategory: "kitchen", costSegItem: "appliances" },
  { pattern: /viking|wolf|sub.?zero|thermador/i, amenity: "Premium appliances", costSegCategory: "kitchen", costSegItem: "appliances" },
  { pattern: /kitchenaid|bosch|ge profile/i, amenity: "Mid-range appliances", costSegCategory: "kitchen", costSegItem: "appliances" },
  { pattern: /island/i, amenity: "Kitchen island", costSegCategory: "kitchen", costSegItem: "cabinetry" },
  { pattern: /custom cabinet|semi.?custom/i, amenity: "Custom cabinetry", costSegCategory: "kitchen", costSegItem: "cabinetry" },
  ...
  { pattern: /heated floor|radiant floor/i, amenity: "Heated floors", costSegCategory: "bathrooms", costSegItem: "bath-features" },

  // Outdoor — note: these only appear on outdoor-categorized room cards (see buildRoomCards filter)
  { pattern: /pool/i, amenity: "Swimming pool", costSegCategory: "outdoor", costSegItem: "pool" },
  { pattern: /hot tub|jacuzzi/i, amenity: "Hot tub / spa", costSegCategory: "outdoor", costSegItem: "pool-features" },
  ...
  { pattern: /pergola|gazebo|cabana/i, amenity: "Pergola / covered patio", costSegCategory: "outdoor", costSegItem: "outdoor-features" },
  ...
  { pattern: /driveway/i, amenity: "Paved driveway", costSegCategory: "outdoor", costSegItem: "outdoor-features" },
  { pattern: /dock|boat lift|pier/i, amenity: "Dock / boat lift", costSegCategory: "outdoor", costSegItem: "waterfront" },
  ...
  { pattern: /lvp|luxury vinyl/i, amenity: "Luxury vinyl plank flooring", costSegCategory: "flooring", costSegItem: "primary-flooring" },
  { pattern: /tile floor/i, amenity: "Tile flooring", costSegCategory: "flooring", costSegItem: "primary-flooring" },
  { pattern: /built.?in|shelving|bookcase/i, amenity: "Built-in shelving", costSegCategory: "interior", costSegItem: "interior-features" },
  { pattern: /crown molding|wainscot/i, amenity: "Crown molding / trim", costSegCategory: "interior", costSegItem: "molding-trim" },
  { pattern: /plantation shutter/i, amenity: "Plantation shutters", costSegCategory: "interior", costSegItem: "window-treatments" },

  // Smart Home
  { pattern: /smart|keypad lock/i, amenity: "Smart lock / keypad", costSegCategory: "smart-home", costSegItem: "smart-features" },
  { pattern: /smart thermostat|nest|ecobee/i, amenity: "Smart thermostat", costSegCategory: "smart-home", costSegItem: "smart-features" },
  { pattern: /home theater|projector|cinema/i, amenity: "Home theater", costSegCategory: "smart-home", costSegItem: "smart-features" },
  { pattern: /security camera|ring doorbell/i, amenity: "Security cameras", costSegCategory: "smart-home", costSegItem: "security" },
  ...
  { pattern: /bunk room|bunk bed/i, amenity: "Bunk room", costSegCategory: "specialty", costSegItem: "entertainment" },
  { pattern: /wine cellar|wine room|wine bar/i, amenity: "Wine cellar / bar", costSegCategory: "specialty", costSegItem: "entertainment" },
  { pattern: /golf sim/i, amenity: "Golf simulator", costSegCategory: "specialty", costSegItem: "unique-features" },

  // Furniture & Personal Property
  { pattern: /restoration hardware|pottery barn|west elm|crate.?barrel|arhaus/i, amenity: "Premium furniture", costSegCategory: "furniture", costSegItem: "furniture-tier" },
  { pattern: /patio furniture|outdoor furniture|lounge chair|chaise|teak furniture/i, amenity: "Outdoor / patio furniture", costSegCategory: "furniture", costSegItem: "patio-furniture" },
  { pattern: /espresso|keurig|nespresso/i, amenity: "Espresso / coffee machine", costSegCategory: "furniture", costSegItem: "small-appliances" },
  { pattern: /kayak|paddleboard|paddle board|surfboard|bikes?/i, amenity: "Activity / recreation gear", costSegCategory: "furniture", costSegItem: "str-specific" },
  { pattern: /fire table|propane fire/i, amenity: "Fire table / propane fire pit", costSegCategory: "furniture", costSegItem: "str-specific" },
  { pattern: /patio heater|outdoor heater/i, amenity: "Outdoor patio heater", costSegCategory: "furniture", costSegItem: "str-specific" },
  { pattern: /pizza oven/i, amenity: "Outdoor pizza oven", costSegCategory: "furniture", costSegItem: "small-appliances" },
  { pattern: /ice maker|nugget ice/i, amenity: "Standalone ice maker", costSegCategory: "furniture", costSegItem: "small-appliances" },
  { pattern: /kegerator|beverage fridge|wine cooler/i, amenity: "Beverage fridge / kegerator", costSegCategory: "furniture", costSegItem: "small-appliances" },
];
...
export function buildRoomCards(images, enrichment) {
  ...
  // Images may carry an `_overrideCat` property to force a specific category
  const groups = {};

  for (const img of images) {
    if (!img || !img.imageUrl) continue;

    // Respect manual overrides from user reassignment
    const catId = img._overrideCat || categorizeImageByCaption(img.caption);
    ...
    // KEY FIX: only add amenities whose costSegCategory belongs to this room.
    // This prevents cross-contamination (e.g., "pool" appearing in a bathroom card
    // when the caption says "Master Bathroom - pool view").
    const roomDef = ROOM_CATEGORIES[catId] || ROOM_CATEGORIES.general;
    const detected = extractAmenitiesFromCaption(img.caption);
    for (const d of detected) {
      const belongsToRoom = roomDef.costSegIds.includes(d.costSegCategory);
      if (belongsToRoom && !groups[catId].captionAmenities.find((a) => a.amenity === d.amenity)) {
  ...
  const cards = [];
  const categoryOrder = ["kitchen", "bathroom", "bedroom", "outdoor", "living", "furniture", "general"];

  for (const catId of categoryOrder) {
    const roomDef = ROOM_CATEGORIES[catId];
    const group = groups[catId];

    // Build amenities from enrichment for this category
    const enrichmentAmenities = [];
    ...
    // Skip this category if no images AND no enrichment data
    if (!group && enrichmentAmenities.length === 0) continue;

    const amenities = [...enrichmentAmenities];
    ...
    const firstCaption = group?.images[0]?.caption || "";
    const specificLabel = deriveRoomLabel(catId, firstCaption);
...
const VISION_ITEM_LABEL_MAP = {
  ...
  "sauna": "Sauna",
  // Furniture & Personal Property
  "luxury-furniture": "Luxury / designer furniture",
  "premium-furniture": "Premium furniture (Pottery Barn / West Elm tier)",
  "mid-furniture": "Mid-range furniture",
  "budget-furniture": "Budget / starter furniture",
  "patio-furniture": "Outdoor / patio furniture",
  "teak-furniture": "Teak outdoor furniture",
  "large-tv": "Large TV(s)",
  "gaming-setup": "Gaming console setup",
  "projector": "Projector / screen",
  "espresso-machine": "Espresso / coffee machine",
  "specialty-cooking": "Specialty cooking appliances",
  "high-end-blender": "High-end blender",
  "fire-table": "Fire table / propane fire pit",
  "pizza-oven": "Outdoor pizza oven",
  "outdoor-heater": "Outdoor / patio heater",
  "portable-grill": "Portable BBQ grill / smoker",
  "bikes": "Bikes (guest use)",
  "kayaks": "Kayaks / paddleboards",
  "beach-gear": "Beach / pool gear (chairs, floats, umbrellas)",
};
...
export function mergeVisionIntoRoomCards(roomCards, visionResults) {
  ...
  // Build a card-by-url index for fast lookup
  const urlToCard = {};
  for (const card of updatedCards) {
    for (const img of card.images) {
      urlToCard[img.imageUrl] = card;
    }
  }
  ...
  for (const result of visionResults) {
    ...
    const card = urlToCard[result.imageUrl];
    if (!card) continue;

    // Flag if vision thinks this image belongs in a different room.
    // Surface this so the UI can prompt the user to reassign.
    const visionCatId = VISION_ROOM_TYPE_MAP[result.room_type] || "general";
    if (visionCatId !== "general" && visionCatId !== card.category) {
      const img = card.images.find((i) => i.imageUrl === result.imageUrl);
      if (img) {
        img._visionCat = visionCatId;
        img._visionCatLabel = ROOM_CATEGORIES[visionCatId]?.label || visionCatId;
      }
    }
